	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_output_15_0 = ( (tex2D( _Texture, uv_Texture )).rgb * (packedInput.ase_color).rgb );
				
				surfaceDescription.Color = temp_output_15_0;
				surfaceDescription.Emission = ( _Emissive_Intensity * temp_output_15_0 );
...
/*ASEBEGIN
Version=18921
125;161;2546;1313;1378.398;390.2328;1;True;True
...
Node;AmplifyShaderEditor.ComponentMaskNode;13;-746.7065,154.904;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-461.3979,-48.23279;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ComponentMaskNode;17;-746.3979,25.76721;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-526.2065,-173.0959;Inherit;False;Property;_Emissive_Intensity;Emissive_Intensity;2;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-241.3979,-229.2328;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;18;2;10;4
ASEEND*/
//CHKSM=F5C5447513A97E189D3216D8115288DD8E34B91F