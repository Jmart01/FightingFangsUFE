	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_output_31_0 = ( (packedInput.ase_color).rgb * ( packedInput.ase_color.a * saturate( ( (0.0 + (( 1.0 - packedInput.ase_texcoord1.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode28.r + tex2DNode28.g ) ) ) ) );
				
				surfaceDescription.Color = temp_output_31_0;
				surfaceDescription.Emission = temp_output_31_0;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode28 = tex2D( _Texture, uv_Texture );
				float3 temp_output_31_0 = ( (packedInput.ase_color).rgb * ( packedInput.ase_color.a * saturate( ( (0.0 + (( 1.0 - packedInput.ase_texcoord.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode28.r + tex2DNode28.g ) ) ) ) );
...
/*ASEBEGIN
Version=18921
258;350;2546;1307;2631.611;1407.707;1.335439;True;True
...
Node;AmplifyShaderEditor.SamplerNode;28;-2179.141,-589.5377;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;ab6dac04b2ccd0d41b88f1ef19e71faf;14e3f7e658e4b9d458b81c50cbcbdd46;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F02A479B7CF85FD6E55B115DAB49F5E4E674261F