	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float temp_output_43_0 = ( packedInput.ase_color.a * saturate( ( (0.0 + (( 1.0 - packedInput.ase_texcoord1.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode28.r + tex2DNode28.g ) ) ) );
				float3 temp_output_31_0 = ( (packedInput.ase_color).rgb * temp_output_43_0 * packedInput.ase_texcoord1.w );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode28 = tex2D( _Texture, uv_Texture );
				float temp_output_43_0 = ( packedInput.ase_color.a * saturate( ( (0.0 + (( 1.0 - packedInput.ase_texcoord.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode28.r + tex2DNode28.g ) ) ) );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode28 = tex2D( _Texture, uv_Texture );
				float temp_output_43_0 = ( packedInput.ase_color.a * saturate( ( (0.0 + (( 1.0 - packedInput.ase_texcoord.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode28.r + tex2DNode28.g ) ) ) );
				float3 temp_output_31_0 = ( (packedInput.ase_color).rgb * temp_output_43_0 * packedInput.ase_texcoord.w );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode28 = tex2D( _Texture, uv_Texture );
				float temp_output_43_0 = ( packedInput.ase_color.a * saturate( ( (0.0 + (( 1.0 - packedInput.ase_texcoord3.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode28.r + tex2DNode28.g ) ) ) );
...
/*ASEBEGIN
Version=18921
-64;1306;2546;1307;2761.028;1410.142;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;28;-2179.141,-589.5377;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;ab6dac04b2ccd0d41b88f1ef19e71faf;e0cf97930b714074ea7ee53a8e61ebd7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;49;-2253.314,-789.7315;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;50;-2039.099,-800.337;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;3;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=45FD94448988BAB2FA173B0AA0E6E7A23321B783