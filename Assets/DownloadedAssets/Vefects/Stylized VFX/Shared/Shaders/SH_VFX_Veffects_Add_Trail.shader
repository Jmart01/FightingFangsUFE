...
Shader "SH_VFX_Veffects_AddTrail"
{
	Properties
	{
		...
		[ASEEnd]_TrailSpeed("TrailSpeed", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord13 = packedInput.ase_texcoord1.xy * appendResult16 + ( _TimeParameters.x * appendResult19 );
				float4 tex2DNode1 = tex2D( _Texture, texCoord13 );
				float3 temp_output_2_0 = ( ( ( tex2DNode1.r + tex2DNode1.g ) * _Emissive_Intensity ) * (packedInput.ase_color).rgb );
				
				surfaceDescription.Color = temp_output_2_0;
				surfaceDescription.Emission = temp_output_2_0;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 appendResult16 = (float2(_TrailScale , 1.0));
				float2 appendResult19 = (float2(_TrailSpeed , 0.0));
				float2 texCoord13 = packedInput.ase_texcoord.xy * appendResult16 + ( _TimeParameters.x * appendResult19 );
				float4 tex2DNode1 = tex2D( _Texture, texCoord13 );
				float3 temp_output_2_0 = ( ( ( tex2DNode1.r + tex2DNode1.g ) * _Emissive_Intensity ) * (packedInput.ase_color).rgb );
...
/*ASEBEGIN
Version=18921
-255;1319;2546;1307;2253.798;729.2283;1.3419;True;True
Node;AmplifyShaderEditor.RangedFloatNode;17;-2482.161,-721.9373;Inherit;False;Property;_TrailScale;TrailScale;2;0;Create;True;0;0;0;False;0;False;1;0.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-2689.461,-273.7379;Inherit;False;Property;_TrailSpeed;TrailSpeed;3;0;Create;True;0;0;0;False;0;False;1;-5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;7;-1118.1,-97.02406;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2;-525.1932,-406.7726;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;42;2;7;4
ASEEND*/
//CHKSM=C9A6959D59ECFDF4554DE53A3B8208E657841436