	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_output_2_0 = ( tex2DNode1.r * (packedInput.ase_color).rgb );
				
				surfaceDescription.Color = temp_output_2_0;
				surfaceDescription.Emission = ( _Emissive_Intensity * temp_output_2_0 );
				surfaceDescription.Alpha = ( tex2DNode1.r * packedInput.ase_color.a );
...
/*ASEBEGIN
Version=18921
109;392;2546;1313;1489.142;625.4827;1;True;True
...
ASEEND*/
//CHKSM=C85607DBBE409076C59168F38176ABAC7708B358