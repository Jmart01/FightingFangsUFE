...
Shader "SH_VFX_Veffects_AddDissolveEmissive"
{
	Properties
	{
		...
		[ASEEnd]_NoiseSpeed("Noise Speed", Vector) = (0,0.2,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord58 = packedInput.ase_texcoord1.xy * _NoiseScale + ( _TimeParameters.x * _NoiseSpeed );
				float2 uv_Texture = packedInput.ase_texcoord1.xy * _Texture_ST.xy + _Texture_ST.zw;
				float4 tex2DNode28 = tex2D( _Texture, uv_Texture );
				float temp_output_54_0 = ( saturate( pow( tex2D( _Noise, texCoord58 ).r , _NoisePower ) ) * tex2DNode28.r );
				float4 color69 = IsGammaSpace() ? float4(0.5,0.2745098,0.127451,1) : float4(0.2140411,0.06124606,0.0148233,1);
				
				float3 temp_output_30_0 = (packedInput.ase_color).rgb;
				
				surfaceDescription.Color = ( ( temp_output_54_0 * 2.0 ) * (color69).rgb );
				surfaceDescription.Emission = ( temp_output_30_0 * ( temp_output_30_0 * ( tex2DNode28.b * packedInput.ase_texcoord2.w ) ) );
				surfaceDescription.Alpha = ( packedInput.ase_color.a * saturate( ( ( 1.0 - packedInput.ase_texcoord2.z ) + ( temp_output_54_0 + tex2DNode28.g ) ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Alpha = ( packedInput.ase_color.a * saturate( ( ( 1.0 - packedInput.ase_texcoord.z ) + ( temp_output_54_0 + tex2DNode28.g ) ) ) );
				surfaceDescription.AlphaClipThreshold = _AlphaCutoff;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord58 = packedInput.ase_texcoord.xy * _NoiseScale + ( _TimeParameters.x * _NoiseSpeed );
				...
				surfaceDescription.Color = ( ( temp_output_54_0 * 2.0 ) * (color69).rgb );
				surfaceDescription.Emission = ( temp_output_30_0 * ( temp_output_30_0 * ( tex2DNode28.b * packedInput.ase_texcoord1.w ) ) );
				surfaceDescription.Alpha = ( packedInput.ase_color.a * saturate( ( ( 1.0 - packedInput.ase_texcoord1.z ) + ( temp_output_54_0 + tex2DNode28.g ) ) ) );
				surfaceDescription.AlphaClipThreshold =  _AlphaCutoff;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord58 = packedInput.ase_texcoord4.xy * _NoiseScale + ( _TimeParameters.x * _NoiseSpeed );
				float2 uv_Texture = packedInput.ase_texcoord4.xy * _Texture_ST.xy + _Texture_ST.zw;
				float4 tex2DNode28 = tex2D( _Texture, uv_Texture );
				float temp_output_54_0 = ( saturate( pow( tex2D( _Noise, texCoord58 ).r , _NoisePower ) ) * tex2DNode28.r );
				
				surfaceDescription.Alpha = ( packedInput.ase_color.a * saturate( ( ( 1.0 - packedInput.ase_texcoord3.z ) + ( temp_output_54_0 + tex2DNode28.g ) ) ) );
				surfaceDescription.AlphaClipThreshold = _AlphaCutoff;
...
/*ASEBEGIN
Version=18921
67;713;2546;1307;2775.572;1383.595;1;True;True
Node;AmplifyShaderEditor.Vector2Node;61;-4110.486,-983.588;Inherit;False;Property;_NoiseSpeed;Noise Speed;5;0;Create;True;0;0;0;False;0;False;0,0.2;-0.4,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;56;-4177.292,-1154.31;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;57;-4033.292,-1426.31;Inherit;False;Property;_NoiseScale;Noise Scale;4;0;Create;True;0;0;0;False;0;False;1,1;0.7,0.7;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-3217.291,-1186.31;Inherit;False;Property;_NoisePower;Noise Power;3;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;-1217.352,-852.4019;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-1563.814,-958.2088;Inherit;False;Property;_Emissive_Intensity;Emissive_Intensity;1;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;69;-2146.168,-1179.958;Inherit;False;Constant;_Color0;Color 0;6;0;Create;True;0;0;0;False;0;False;0.5,0.2745098,0.127451,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;73;2;43;0
ASEEND*/
//CHKSM=CFDB126B9F0F60C5A53A419CD684A6D27BA85FCE