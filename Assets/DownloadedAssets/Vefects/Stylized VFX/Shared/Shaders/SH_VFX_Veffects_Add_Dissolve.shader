	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord68 = packedInput.ase_texcoord1.xy * _NoiseScale + ( _TimeParameters.x * _NoiseSpeed );
				float2 uv_Texture = packedInput.ase_texcoord1.xy * _Texture_ST.xy + _Texture_ST.zw;
				float3 temp_output_31_0 = ( (packedInput.ase_color).rgb * ( packedInput.ase_color.a * saturate( ( saturate( ( saturate( pow( tex2D( _Noise, texCoord68 ).r , _NoisePower ) ) * tex2D( _Texture, uv_Texture ).r ) ) + (0.0 + (( 1.0 - packedInput.ase_texcoord2.z ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ) ) ) );
				
				surfaceDescription.Color = temp_output_31_0;
				surfaceDescription.Emission = ( temp_output_31_0 * packedInput.ase_texcoord2.w );
				surfaceDescription.Alpha = packedInput.ase_texcoord2.w;
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Alpha = packedInput.ase_texcoord.w;
				surfaceDescription.AlphaClipThreshold = _AlphaCutoff;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord68 = packedInput.ase_texcoord.xy * _NoiseScale + ( _TimeParameters.x * _NoiseSpeed );
				float2 uv_Texture = packedInput.ase_texcoord.xy * _Texture_ST.xy + _Texture_ST.zw;
				float3 temp_output_31_0 = ( (packedInput.ase_color).rgb * ( packedInput.ase_color.a * saturate( ( saturate( ( saturate( pow( tex2D( _Noise, texCoord68 ).r , _NoisePower ) ) * tex2D( _Texture, uv_Texture ).r ) ) + (0.0 + (( 1.0 - packedInput.ase_texcoord1.z ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ) ) ) );
				
				surfaceDescription.Color = temp_output_31_0;
				surfaceDescription.Emission = ( temp_output_31_0 * packedInput.ase_texcoord1.w );
				surfaceDescription.Alpha = packedInput.ase_texcoord1.w;
				surfaceDescription.AlphaClipThreshold =  _AlphaCutoff;
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Alpha = packedInput.ase_texcoord3.w;
				surfaceDescription.AlphaClipThreshold = _AlphaCutoff;
...
/*ASEBEGIN
Version=18921
168;597;2546;1307;3533.644;1383.139;1.656094;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-1255.652,-1003.408;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;-938.5447,-907.8403;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;75;-1996.942,-1457.04;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;64;-3528.319,-1545.547;Inherit;True;Property;_Noise;Noise;1;0;Create;True;0;0;0;False;0;False;-1;57e9e92fd03983b41bdbda66dc81e6b2;2c5f648e215789a4599c67843b5f7e9a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;28;-2977.035,-1203.95;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;d8a7e4b0bc507d54193801e43fe6b7d7;d8a7e4b0bc507d54193801e43fe6b7d7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;83;-1005.652,-446.6709;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;83;0;24;4
WireConnection;76;0;31;0
WireConnection;76;1;84;0
WireConnection;76;2;83;0
ASEEND*/
//CHKSM=136D59686D162826E1AFCDAB627A138860E02EBB