...
Shader "SH_VFX_Veffects_AB"
{
	Properties
	{
		...
		[ASEEnd]_CamOffet_Amount("CamOffet_Amount", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord11 = inputMesh.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#endif
				float3 vertexValue = ( ( ase_worldPos - _WorldSpaceCameraPos ) * ( ( _CamOffet_Amount + texCoord11.y ) * 0.01 ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Emission = ( temp_output_2_0 * _Emissive_Intensity );
...
/*ASEBEGIN
Version=18921
405;226;2546;1319;2307.158;699.8176;1.608726;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-181.9014,-303.4142;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2;-359,-373.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;19;6;18;0
ASEEND*/
//CHKSM=FE017D2EE6E0AD3ED4F76A519BF4DFDB182AF146