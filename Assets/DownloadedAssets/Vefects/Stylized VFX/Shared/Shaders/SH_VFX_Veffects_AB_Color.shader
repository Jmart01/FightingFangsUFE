...
Shader "SH_VFX_Veffects_ABColor"
{
	Properties
	{
		...
		[ASEEnd]_Boost_Opacity("Boost_Opacity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = ( tex2DNode11 * float4( (packedInput.ase_color).rgb , 0.0 ) * _Boost_Opacity * packedInput.ase_color.a ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode11.a * packedInput.ase_color.a );
...
/*ASEBEGIN
Version=18921
234;104;2546;1307;1400.096;453.2243;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-677.2065,225.9041;Inherit;False;Property;_Boost_Opacity;Boost_Opacity;1;0;Create;True;0;0;0;False;0;False;1;2.32;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B6ED26AB3E5699B5A900328B0E0D0901B68170B4