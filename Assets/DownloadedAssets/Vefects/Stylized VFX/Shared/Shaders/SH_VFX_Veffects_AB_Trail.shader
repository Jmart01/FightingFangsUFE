	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_output_2_0 = ( ( temp_output_35_0 * _Emissive_Intensity ) * (packedInput.ase_color).rgb * packedInput.ase_color.a );
				
				surfaceDescription.Color = temp_output_2_0;
				surfaceDescription.Emission = temp_output_2_0;
				surfaceDescription.Alpha = ( temp_output_35_0 * packedInput.ase_color.a );
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult16 = (float2(_TrailScale , 1.0));
				float2 appendResult19 = (float2(_TrailSpeed , 0.0));
				float2 texCoord13 = packedInput.ase_texcoord3.xy * appendResult16 + ( _TimeParameters.x * appendResult19 );
				float4 tex2DNode1 = tex2D( _Texture, texCoord13 );
				float temp_output_35_0 = ( tex2DNode1.r + tex2DNode1.g );
...
/*ASEBEGIN
Version=18921
257;257;2546;1313;2901.234;1025.453;2.037528;True;True
...
ASEEND*/
//CHKSM=E9771A30D1D8A0B99CD8EF9857AA23ACA82ADF8E