...
Shader "/_Vefects_/T/SH_VFX_Vefects_Bomb"
{
	Properties
	{
		...
		[ASEBegin][HDR]_Color2("Color 2", Color) = (0.6415094,0.1361695,0.1361695,0)
		[HDR]_Color0("Color 0", Color) = (0.2980392,0.4666663,1,0)
		[HDR]_Color1("Color 1", Color) = (0.2122642,0.8048544,1,0)
		[ASEEnd]_Shadow("Shadow", Color) = (0.1766198,0.1845427,0.254717,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord138 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult144 = lerp( _Color1 , _Color0 , abs( sin( ( texCoord138.x * 31.45 ) ) ));
				float2 texCoord147 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult149 = lerp( lerpResult144 , _Color2 , step( texCoord147.y , 0.5 ));
				float3 temp_output_220_0 = (( lerpResult149 * _Shadow )).rgb;
				
				surfaceDescription.Color = temp_output_220_0;
				surfaceDescription.Emission = temp_output_220_0;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord138 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult144 = lerp( _Color1 , _Color0 , abs( sin( ( texCoord138.x * 31.45 ) ) ));
				float2 texCoord147 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult149 = lerp( lerpResult144 , _Color2 , step( texCoord147.y , 0.5 ));
				float3 temp_output_220_0 = (( lerpResult149 * _Shadow )).rgb;
...
/*ASEBEGIN
Version=18921
-62;1408;2546;1325;1571.298;1000.363;1.451593;True;True
Node;AmplifyShaderEditor.CommentaryNode;89;36.55181,-5.405043;Inherit;False;891;430.5521;Push Particle toward camera direction (no more glow clipping in the ground) | 0=Unabled;7;80;81;82;83;84;85;87;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;145;-1455.821,-247.3385;Inherit;False;Property;_Color0;Color 0;1;1;[HDR];Create;True;0;0;0;False;0;False;0.2980392,0.4666663,1,0;0,5.902724,23.96863,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;82;390.5517,115.147;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;-1680.432,17.57304;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;132;-475.6791,-768.0814;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;134;-897.6791,-750.0814;Inherit;False;Property;_Shadow;Shadow;3;0;Create;True;0;0;0;False;0;False;0.1766198,0.1845427,0.254717,0;0.624,0.6713846,0.8,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;87;608.6498,210.0679;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;148;-934.7209,211.927;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;85;403.5517,230.1471;Inherit;False;Property;_CameraDirPush;CameraDirPush;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;220;287.1979,-762.3073;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldPosInputsNode;80;161.8317,44.59492;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;765.5524,99.14715;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;83;558.5521,108.147;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.AbsOpNode;162;-1420.133,75.47101;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;150;-1091.487,-220.8322;Inherit;False;Property;_Color2;Color 2;0;1;[HDR];Create;True;0;0;0;False;0;False;0.6415094,0.1361695,0.1361695,0;0.1614458,0.2433735,0.4,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;141;-1845.354,113.1672;Inherit;False;Constant;_Float1;Float 1;8;0;Create;True;0;0;0;False;0;False;31.45;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;146;-1725.073,-238.6923;Inherit;False;Property;_Color1;Color 1;2;1;[HDR];Create;True;0;0;0;False;0;False;0.2122642,0.8048544,1,0;0,24.1194,32,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;138;-1907.932,-20.09189;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=DFDD9BE542903D556EDE98E368AA7DFA21CAE60F