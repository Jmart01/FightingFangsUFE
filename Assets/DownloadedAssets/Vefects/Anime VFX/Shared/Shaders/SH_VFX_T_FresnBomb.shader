	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float fresnelNdotV153 = dot( ase_worldNormal, V );
				...
				float2 uv_DissolveMask = packedInput.ase_texcoord2.xy * _DissolveMask_ST.xy + _DissolveMask_ST.zw;
				...
				float4 uvs4_DissolveMask = packedInput.ase_texcoord2;
				uvs4_DissolveMask.xy = packedInput.ase_texcoord2.xy * _DissolveMask_ST.xy + _DissolveMask_ST.zw;
				...
				float4 texCoord24 = packedInput.ase_texcoord2;
				texCoord24.xy = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float fresnelNdotV125 = dot( ase_worldNormal, V );
				...
				float screenDepth132 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth132 = abs( ( screenDepth132 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Dist ) );
				float lerpResult169 = lerp( ( packedInput.ase_color.a * saturate( step( ( saturate( ( temp_output_59_0 + ( temp_output_26_0 * _GlowIntensity ) ) ) * _AlphaBoldness ) , ( fresnelNode125 + saturate( ( ( 1.0 - distanceDepth132 ) * 1.0 ) ) ) ) ) ) , saturate( step( ( temp_output_66_0 + packedInput.ase_color.a + _AddDiss ) , temp_output_162_0 ) ) , myVarName174);
				
				surfaceDescription.Color = ( saturate( lerpResult74 ) * _Brightness ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = lerpResult169;
...
/*ASEBEGIN
Version=18921
108;231;2546;1337;1132.052;1046.093;1.3;True;True
...
WireConnection;182;2;169;0
ASEEND*/
//CHKSM=235A6A2CBEF038680A24910B313225721D317BB5